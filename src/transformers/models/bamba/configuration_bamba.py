...
class BambaConfig(PretrainedConfig):
    ...
    The BambaModel is a Huggingface implementation of modules/mamba2.py from https://github.com/state-spaces/mamba with 
    hybrid transformer attention layers. We based this implementation off that of AI21 JamabModel's, where the key difference
    is that here the mixer is a version2 mixer (as mentioned above), and here MoE layers are not used.
