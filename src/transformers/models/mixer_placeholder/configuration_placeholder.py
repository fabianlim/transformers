...
class PlaceholderConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`PlaceholderModel`]. It is used to instantiate a
    Placeholder model according to the specified arguments, defining the model architecture. Instantiating a configuration
    with defaults taken from the IBM checkpoint.

    This is inspired by the AI21 JamabModel with changes
    - removal of MoE layers
    - padding-free support

    c.f., [ai21labs/Jamba-v0.1](https://huggingface.co/ai21labs/Jamba-v0.1)
